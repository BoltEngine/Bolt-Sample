...
It's included a Prefab capable of generating new keys and properly initialize and clear the Encryption System when 
destroyed.
...
In order to properly use the system, you must build/use a backend service capable of communicating the peers in a 
secure manner, used to exchange the keys among the game clients, ensuring that all connection is encrypted. 